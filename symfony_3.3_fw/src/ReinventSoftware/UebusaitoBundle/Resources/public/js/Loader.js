...
function Loader() {
    ...
    self.create = function(type) {
        if (type === "image")
            $("<div id=\"request_loader\" class=\"display_none shadow\"><img src=\"" + window.url.webBundle + "/images/templates/" + window.settings.template + "/request_loader.gif\" alt=\"request_loader.gif\"/></div>").appendTo("body");
