...
function Loader() {
    ...
    self.create = function(type) {
        if (type === "image")
            $("<div id=\"loader_request\" class=\"display_none shadow\"><img src=\"" + window.url.root + "/bundles/uebusaito/images/templates/" + window.settings.template + "/loader_request.gif\" alt=\"loader_request.gif\"/></div>").appendTo("body");
